...
$(window).load(function () {
    ...
    $('#radioName').change(function() {
        if($("#radioName").is(":checked")) {
            $("#inputIdTask").val('');
            $("#inputIdTask").prop('disabled', true);
            $("#inputName").prop('disabled', false);
            $("#inputDescription").val('');
            $("#inputDescription").prop('disabled', true);
        }
    });
    $('#radioIdTask').change(function() {
        if($("#radioIdTask").is(":checked"))
        {
            $("#inputIdTask").prop('disabled', false);
            $("#inputName").val('');
    ...
    $('#checkboxTask').change(function() {
        if($("#checkboxTask").is(":checked")) {
